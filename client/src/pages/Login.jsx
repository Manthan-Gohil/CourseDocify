        ...
        <form onSubmit={submitHandler}>
          <div className="w-full flex flex-col max-w-[450px]">
            ...
            <div className="w-full flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm font-medium whitespace-nowrap cursor-pointer underline underline-offset-2">
                Forgot Password?
              </Link>
            </div>
            ...
            <div className="w-full flex flex-col my-4">
              ...
              <Link to="/register" className="w-full text-[#060606] my-2 font-semibold border border-black bg-white rounded-md p-3 text-center flex items-center justify-center cursor-pointer">
                Register
              </Link>
            </div>
            ...
            <div className="w-full text-sm text-[#060606] my-2 font-semibold bg-white border border-black rounded-md p-3 text-center flex items-center justify-center">
              <img
